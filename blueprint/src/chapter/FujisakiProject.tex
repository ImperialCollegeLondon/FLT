...
\begin{lemma}
  \label{NumberField.AdeleRing.DivisionAlgebra.Aux.Y_meet_units_D}
...
\begin{definition}
  \label{NumberField.AdeleRing.DivisionAlgebra.Aux.K}
  Define $K:= (T^{-1}.X) \times X\subset D_{\A}\times D_{\A}$.
\end{definition}

\begin{lemma}
  \label{NumberField.AdeleRing.DivisionAlgebra.Aux.K_compact}
  \uses{NumberField.AdeleRing.DivisionAlgebra.Aux.K, NumberField.AdeleRing.DivisionAlgebra.Aux.T,
  NumberField.AdeleRing.DivisionAlgebra.Aux.X_compact}
  $K$ is compact.
\end{lemma}
\begin{proof}
   $X$ is compact and $T$ is finite. {\bf TODO} do we use this?
\end{proof}

\begin{lemma}
  \label{NumberField.AdeleRing.DivisionAlgebra.Aux.antidiag_mem_K}
...
\begin{proof}
  ...
  NumberField.AdeleRing.DivisionAlgebra.Aux.X_meets_kernel',
  NumberField.AdeleRing.DivisionAlgebra.Aux.K}
...
\begin{theorem}
  \label{NumberField.AdeleRing.DivisionAlgebra.units_cocompact}
  $D^\times\backslash D_{\A}^{(1)}$ is compact.
\end{theorem}
\begin{proof}
  \uses{DistribHaarChar.continuous, NumberField.AdeleRing.DivisionAlgebra.Aux.antidiag_mem_K,
  Y_meet_units_D}
  ...
  Lemma~\ref{NumberField.AdeleRing.DivisionAlgebra.Aux.antidiag_mem_K} shows that $M$ surjects onto
...
\end{theorem}
\begin{proof}
  \uses{NumberField.AdeleRing.DivisionAlgebra.units_cocompact}

...
\end{proof}
  ...
  \begin{proof}
    ...
    Because tensoring by a finitely presented module commutes with restricted products and binary
    products this equals $\prod'_p(L\otimes_{\Z}\Q_p)\times(L\otimes_{\Z}\R)$, the restricted

...
\begin{remark} In the Lean file we make the additional assumption that the index set over
  ...
  countable index set because then the product is a Borel sigma algebra and this is all we
  need in our applications to adeles. We also put some possibly spurious second countable
  hypotheses on things, which are again harmless in our application.
\end{remark}
\begin{proof}
  \leanok

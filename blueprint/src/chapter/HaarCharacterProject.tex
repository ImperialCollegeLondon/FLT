...
\end{lemma}
\begin{remark}
  TODO: we actually need to prove this for "nice" automorphisms of finite free modules
  over a commutative ring, which is done in this PR. Here "nice" means "a product
  of transvections and diagonal matrices".
\end{remark}
\begin{proof}
\uses{MeasureTheory.addEquivAddHaarChar}
\leanok

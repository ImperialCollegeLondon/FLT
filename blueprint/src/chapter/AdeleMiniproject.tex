...
\begin{proof}
  ...
  $\omega_1,\omega_2,\ldots,\omega_n$ for $L/K$. Then $\omega_1A\oplus\cdots\oplus\omega_nA$ and $B$ are two $A$-lattices in $L$, so they agree at almost all primes. In particular
  ...
  then it's well-known that $D(\omega_1,\omega_2,\ldots,\omega_n)$ is a $v$-adic
  unit for all but finitely many $v$.

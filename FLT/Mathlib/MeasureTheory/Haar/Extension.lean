...
theorem not_injOn_of_measure_gt
  ...
  use ((haarScalarFactor (h.inducedMeasure haar haar) haar)⁻¹ •
  ...
  · rw [inv_smul_lt_iff_of_pos (haarScalarFactor_pos_of_isHaarMeasure _ _)] at hU'
    apply h.not_injOn_of_inducedMeasure_gt haar haar U hU
    rwa [measure_isHaarMeasure_eq_smul_of_isOpen (h.inducedMeasure haar haar) haar hU]

...
instance Pi.instTopologicalModule {ι : Type*} (R : Type*) [Ring R] [TopologicalSpace R] [IsTopologicalRing R]
    {M : ι →  Type*} [∀ i, AddCommGroup (M i)] [∀ i, Module R (M i)] [∀ i, TopologicalSpace (M i)]
    [∀ i, IsTopologicalModule R (M i)] :

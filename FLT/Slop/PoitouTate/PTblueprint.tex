...
\begin{thm}[Milne, Example 1.6] \label{thm:cup-prod-duality}
    \begin{enumerate}[label=(\arabic*)]
        ...
        \[ H^2(G_v/I_v, {K^{\operatorname{un}}}^\times)\to H^2(G_v,\overline{K}^\times) \]
        is an isomorphism. We define \( \operatorname{inv}_{G_v}: H^2(G_v,\overline{K}^\times)\to \Q/\Z \) to be the composition of the inverse of this isomorphism with the following isomorphisms:
        \[ H^2(G_v/I_v,{K^{\operatorname{un}}}^\times)\xrightarrow{\operatorname{ord}} H^2(G_v/I_v,\Z) \xrightarrow{\operatorname{inv}_{G_v/I_v}} \Q/\Z. \]
        Denote the map from $H^2 (G_v, \overline{K}^\times) \to \Q/\Z$ to be $\varphi$.
    \end{enumerate}
\end{thm}
...
of \( M^* = \Hom(M, \overline{K}^\times) \), where \( R^{\operatorname{un}} \) denotes
...
\begin{thm}[Milne, Theorem 2.6]
    ...
    \[ H^1(G_v, M) \times H^1(G_v, M^*) \to H^2(G_v, \overline{K}^\times) \cong \Q/\Z. \]
\end{thm}
...
\begin{align*}
0 \to  H^0 (G_S, M) \xrightarrow{\alpha_0} \prod_{l \in S_f} \hat{H}^0 (G_l, M) \xrightarrow{\beta_0} H^2 (G_{S}, M^*)^\vee \\
\to  H^1 (G_S, M) \xrightarrow{\alpha_1} \prod_{l \in S} H^1 (G_l, M) \xrightarrow{\beta_1} H^1 (G_S, M^*)^\vee \\
\to H^2 (G_S, M) \xrightarrow{\alpha_2} \prod_{l \in S} H^2 (G_l, M) \xrightarrow{\beta_2} H^0 (G_S, M^*)^\vee \to 0
\end{align*}

\bigskip
\textit{Note that for $p >2$, $\hat{H}^0 (G_{\R}, M) = 0$. For $p = 2$, see either Washington Galois cohomology or Milne for the $p = 2$ case. }
\end{thm}
